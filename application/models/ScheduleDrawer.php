<?php
    ...
    {
        public function draw($_blockdata)
        {
            // TODO: Function handling the block-drawing.
        }
         ...
         */
        protected function get_top_offset($_begintime)
        {
         ...
         */
        protected function get_block_height($_begintime, $_endtime)
        {
